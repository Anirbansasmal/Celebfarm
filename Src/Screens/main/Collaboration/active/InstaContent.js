      ...
      getInstaFeedDetails(
        ...
        .then(res => {
          ...
          res?.data?.data?.map(itempst => {
            if (itempst?.media_type == item?.toUpperCase()) {
              arr.push(itempst);
            } else if (
              itempst?.media_type?.toUpperCase() == 'VIDEO'
                ? item == 'Reels'
                : false
            ) {
              arr.push(itempst);
      ...
      <SafeAreaView style={{flex: 1, backgroundColor: Colors.black}}>
        ...
        <View
          ...
          <ButtonLinear
            ...
            onPress={() => {
              props.navigation.navigate('ContentPer', {
                data: contentinsta,
